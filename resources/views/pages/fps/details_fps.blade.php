            ...
            <div>
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Détails PF</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex" style="background-color: #c8cdd259; padding: 10px; border-radius: 5px;">
                            ...
                            <button type="button" class="btn btn-primary ms-2 w-100 btn-filter" data-table="fps-table">
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (button) {
                    button.addEventListener('click', (e) => {
                        ...
                        fetch('{{ route('search-rapports-id-fp', $findUser->id) }}', {
                                method: 'POST',
                                headers: {
