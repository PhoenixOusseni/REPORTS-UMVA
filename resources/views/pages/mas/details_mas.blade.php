                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="d-flex" style="background-color: #c8cdd259; padding: 10px; border-radius: 5px;">
                            ...
                            <button type="button" class="btn btn-primary ms-2 w-100 btn-filter" data-table="mas-table">
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (button) {
                    button.addEventListener('click', (e) => {
                        ...
                        fetch('{{ route('search-rapports-id-ma', $findUser->id) }}', {
                                method: 'POST',
                                headers: {
                        ...
                        <li>
                            <a href="#" class="text-decoration-none">
                                <div class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="/rapports/gestions_rapports_ma/${item.id}/download" class="btn btn-primary btn-sm">
                                            <i class="bi bi-download"></i> Télécharger
                                        </a>
                                    </div>
                                </div>
