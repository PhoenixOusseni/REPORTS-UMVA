                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex" style="background-color: #c8cdd259; padding: 10px; border-radius: 5px;">
                                    <input type="date" id="dateDebut-groupes" class="form-control filter-date-start"
                                        data-table="groupes-table">
                                    <input type="date" id="dateFin-groupes" class="form-control filter-date-end ms-2"
                                        data-table="groupes-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger btn-sm"
                                                ...
                                                <form action="{{ route('gestions_rapports_groupes.destroy', $item->id) }}"
                            ...
                            <tbody>
                                @forelse ($rapportsKa as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('gestions_rapports_ka.download', $item->id) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="bi bi-download"></i>
                                            </a>
                                            <a href="#" class="btn btn-danger btn-sm"
                                                onclick="event.preventDefault(); this.querySelector('form').submit();">
                                                <i class="bi bi-trash"></i>
                                                <form action="{{ route('gestions_rapports_ka.destroy', $item->id) }}"
                                                    method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm"
                                            onclick="event.preventDefault(); this.querySelector('form').submit();">
                                            <i class="bi bi-trash"></i>
                                            <form action="{{ route('gestions_rapports_ma.destroy', $item->id) }}"
                                                method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" class="btn btn-danger btn-sm"
                                            onclick="event.preventDefault(); this.querySelector('form').submit();">
                                            <i class="bi bi-trash"></i>
                                            <form action="{{ route('gestions_rapports_fp.destroy', $item->id) }}"
                                                method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                ...
                document.querySelectorAll('.btn-filter').forEach(button => {
                    ...
                    button.addEventListener('click', (e) => {
                        ...
                        if (!dateDebut || !dateFin) {
                            console.error('Champs de date non trouvés:', `dateDebut-${suffix}`,
                                `dateFin-${suffix}`);
